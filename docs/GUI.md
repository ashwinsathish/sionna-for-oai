...
The interactive scene viewer inherited from [NVlabs/sionna-rt-gui](https://github.com/NVlabs/sionna-rt-gui).
For the OAI channel-bridge workflow, see the [main README](../README.md).
